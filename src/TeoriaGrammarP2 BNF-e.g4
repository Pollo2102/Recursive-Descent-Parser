...
optional_func_dec: func_head body [optional_func_dec] ;
...
prm_list:   bool_expr [ ',' bool_expr ]
            ;

function:   [qualifier] ID '(' par_list ')'
            ;
